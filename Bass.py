...
for i in range(len(instance_set)):
    ...
    sense = "music" if "bass%music" in instance_set[i] else "fish"
...
print("Average accuracy for Bass Dataset: ", np.mean(accuracies))


output_file = "Bass.wsd.out"
sense_names = ["bass%music", "bass%fish"]
