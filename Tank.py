...
for i in range(len(instance_set)):
    ...
    sense = "container" if "tank%container" in instance_set[i] else "vehicle"
...
print("Average accuracy for Tank Dataset: ", np.mean(accuracies))


output_file = "Tank.wsd.out"
sense_names = ["tank%container", "tank%vehicle"]
