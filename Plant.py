...
for i in range(len(instance_set)):
    ...
    sense = "factory" if "plant%factory" in instance_set[i] else "living"
...
print("Average accuracy for Plant Dataset: ", np.mean(accuracies))


output_file = "plant_wsd.out"
sense_names = ["plant%factory", "plant%living"]
