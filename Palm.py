...
for i in range(len(instance_set)):
    ...
    sense = "hand" if "palm%hand" in instance_set[i] else "tree"
...
print("Average accuracy for Palm Dataset: ", np.mean(accuracies))


output_file = "palm.wsd.out"
sense_names = ["palm%hand", "palm%tree"]
