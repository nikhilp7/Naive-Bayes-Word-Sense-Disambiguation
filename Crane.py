...
for i in range(len(instance_set)):
    ...
    sense = "machine" if "crane%machine" in instance_set[i] else "bird"
...
print("Average accuracy for Crane Dataset: ", np.mean(accuracies))


output_file = "crane_wsd.out"
sense_names = ["crane%machine", "crane%bird"]
